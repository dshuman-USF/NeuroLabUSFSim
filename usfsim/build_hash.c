...
struct StructInfo;
/* maximum key range = 387, duplicates = 0 */
  ...
  static unsigned short asso_values[] =
    {
      ...
      503, 503, 503, 503, 503, 503, 503, 503, 503, 503,
      503, 503, 503, 503, 503, 503, 503, 503, 503, 503,
      503, 503, 503, 503, 503, 503,   0, 503, 503,  85,
       55, 503, 503, 503, 503, 503, 503, 503, 503, 503,
      503, 503, 503, 503, 503,   5,   5,   5,   0,  70,
        0,   5, 503,  30, 503,   5,   0, 503,  70,   0,
      503, 503,   5,  80,   5, 145, 503,   0,   0, 503,
      503, 503, 503, 503, 503,   0, 503,   0,  30,   0,
        0,   5,   0,   0,  65,   0,  90,  75,  10,   5,
       25,   0,  10, 125,   0,   0,   0,  25,  40,   0,
       55,  50,  65, 503, 503, 503, 503, 503, 503, 503,
      503, 503, 503, 503, 503, 503, 503, 503, 503, 503,
      503, 503, 503, 503, 503, 503, 503, 503, 503, 503,
      503, 503, 503, 503, 503, 503, 503, 503, 503, 503,
      503, 503, 503, 503, 503, 503, 503, 503, 503, 503,
  ...
  static struct StructInfo wordlist[] =
    {
      ...
      {""}, {""}, {""}, {""}, {""}, {""}, {""}, {""},
      {"F_NODE.offset", offsetof (F_NODE,offset), ato_int, str_int, 0, 0, sizeof (int), 1, 0, 0, 0, 0, 0, 0, 0, 1},
      {""}, {""},
      ...
      {""},
      {"F_NODE.aff_prob", offsetof (F_NODE,aff_prob), ato_double, str_double, 0, 0, sizeof (double), 32, 0, 0, 0, 0, 0, 0, 0, 1},
      ...
      {"F_NODE.aff_val", offsetof (F_NODE,aff_val), ato_double, str_double, 0, 0, sizeof (double), 32, 0, 0, 0, 0, 0, 0, 0, 1},
      {"F_NODE.afferent_prog", offsetof (F_NODE,afferent_prog), ato_char_string, str_char_string, 0, 0, sizeof (char), 1024, 0, 0, 0, 0, 0, 0, 1, 1},
      {""},
      ...
      {"F_NODE.num_aff", offsetof (F_NODE,num_aff), ato_int, str_int, 0, 0, sizeof (int), 1, 0, 0, 0, 0, 0, 0, 0, 1},
      {"F_NODE.afferent_file", offsetof (F_NODE,afferent_file), ato_char_string, str_char_string, 0, 0, sizeof (char), 1024, 0, 0, 0, 0, 0, 0, 1, 1},
      {""},
      ...
      {"S_NODE.lrn_delta", offsetof (S_NODE,lrn_delta), ato_double, str_double, 0, 0, sizeof (double), (5 * 20), 0, 0, 0, 0, 0, 0, 0, 1},
      ...
      {"S_NODE.lrn_window", offsetof (S_NODE,lrn_window), ato_int, str_int, 0, 0, sizeof (int), (5 * 20), 0, 0, 0, 0, 0, 0, 0, 1},
      ...
      {""}, {""}, {""}, {""}, {""},
      {"S_NODE.lrn_maxstr", offsetof (S_NODE,lrn_maxstr), ato_double, str_double, 0, 0, sizeof (double), (5 * 20), 0, 0, 0, 0, 0, 0, 0, 1},
